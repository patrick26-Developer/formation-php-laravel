...
$routeur = new Routeur();
$routeur->get('/taches/{id}', fn(string $id) => print("Showing task number $id"));

$routeur->distribuer('GET', '/taches/42'); // Showing task number 42
