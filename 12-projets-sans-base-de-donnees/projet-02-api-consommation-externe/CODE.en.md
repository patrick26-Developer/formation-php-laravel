...
- [bin/meteo.php](bin/meteo.php)

## `src`

- [src/MeteoClient.php](src/MeteoClient.php)

## `src/Cache`

- [src/Cache/FileCache.php](src/Cache/FileCache.php)

## `tests`

- [tests/MeteoClientTest.php](tests/MeteoClientTest.php)
